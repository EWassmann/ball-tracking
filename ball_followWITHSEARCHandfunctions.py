...
while True:
  ...
  #b keeps track of what the last command given was, ls keeps track of what the last search command rotation was,
  #  h is used to retrieve the previous x value.
  # nb keeps track if the robot searched the last time through the loop or if it caught a 
  # glimpse of the ball. the intention is that if it was searching in a clockwise motion, caught the ball
  # and went straight or something and then lost it, it should now go in a counter clockwise 
  # motion because it probably overshot the ball  q is wether it is in search mode or still looking close to 
